...
namespace db_lab5.Controllers
{
	...
	public class LabsController : Controller
	{
		...
		{
			var labRunner = new Lab2Runner(model.FirstInputNumber, model.SecondInputNumber);
		...
		{
			var labRunner = new Lab3Runner(model.FirstInputLine, model.SecondInputLine, model.ThirdInputLine);
